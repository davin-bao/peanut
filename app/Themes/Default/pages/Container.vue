...
<script>
    ...
    export default {
        ...
        mounted () {
            this.$store.commit('setBreadcrumbs', [{ text: 'menu.home'}, { text: 'menu.container'}]);
            this.refreshAll();
            this.test();
        },
        methods: {
...
//                var socket = new WebSocket('ws://192.168.188.208:2375/containers/119ab98bceccd1b46c7bc96cab1502c9738a32c91341e6bf660d0b7a7890c5ac/attach/ws?logs=1&stdin=1&stderr=1&stdout=1&stream=1');
//
//                term.attach(socket);
                ...
                socket.onopen = function(event) {
                    //TODO: change ws.send to req.ws.send
                    console.log(socket.send('/bin/sh'));
                    socket.send("ls\n");
                    socket.send("exit\n");
